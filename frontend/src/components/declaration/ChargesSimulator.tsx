            ...
            <div className="space-y-6">
                ...
                {selectedRegime && (
                    <div className="bg-white/10 p-4 rounded-lg border border-gray-700">
                        ...
                        <p className="text-white font-medium">{selectedRegime.name}</p>
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-white/10 border border-gray-700 rounded-lg px-4 py-2 text-white"
                        min="0"
                        step="100"
                    />
                </div>
                ...
                <button
                    ...
                    className="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed transition-colors duration-200"
                >
                    Simuler les charges
                </button>
                ...
                {isSimulated && selectedRegime && (
                    <div className="pt-4 border-t border-gray-700">
                        <div className="flex justify-between items-center mb-2">
                            <span className="text-white">Charges ({selectedRegime.rate}%)</span>
                            ...
                            <div className="space-y-3 max-h-[400px] overflow-y-auto">
                                {TAX_REGIMES.find(p => p.period === selectedPeriod)?.regimes.map((regime) => (
                                    <button
                                        ...
                                        className="w-full p-4 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 transition-colors duration-200"
                                    >
